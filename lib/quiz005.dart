...
class quiz005 extends StatefulWidget {
  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<quiz005> {
  List<Map<String, dynamic>> questions = [
    {
      'question': 'night แปลว่าอะไร?',
      'options': [
        'กลางคืน',
        'นางฟ้า',
        'ดาว',
