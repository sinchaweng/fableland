...
class quiz004 extends StatefulWidget {
  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<quiz004> {
  List<Map<String, dynamic>> questions = [
    {
      'question': 'apples แปลว่าอะไร?',
      'options': [
        'แอปเปิ้ล',
        'แม่เลี้ยง',
        'ฆ่า',
    ...
    {
      'question': 'stepmother แปลว่าอะไร?',
      'options': [
        'แอปเปิ้ล',
        'แม่เลี้ยง',
        'ฆ่า',
