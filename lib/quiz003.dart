...
class quiz003 extends StatefulWidget {
  @override
  _QuizPageState createState() => _QuizPageState();
}

class _QuizPageState extends State<quiz003> {
  List<Map<String, dynamic>> questions = [
    {
      'question': 'daughters แปลว่าอะไร?',
      'options': [
        'ลูกสาว',
        'พายุ',
        'เมือง',
